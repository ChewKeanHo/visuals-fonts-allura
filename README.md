# Allura Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

The Allura font characters are simple and clean and very legible, with an almost
handwritten calligraphic appeal designed by the
[Allura Project Team](https://github.com/googlefonts/allura). The script and
formal sets offer a softer, more formal look. This exceptionally diverse font
was designed with advertising, display and package design in mind. This OpenType
Pro version of Allura combines all three styles along with extra alternate
glyphs and flourished graphics to give designers maximum flexibility.
...
```
Title: Allura Font
Creators: The Allura Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-allura
UUID: 188CE614-0B61-41E1-B531-2D77772E7735
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-allura
```
